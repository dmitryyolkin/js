...
define('models/User',['require','Backbone'],function(require){
...
define('collections/UsersCollection',['require','Backbone'],function(require){
    var Backbone = require('Backbone');
...
define('controllers/Controller',['require','Backbone','underscore'],function(require){
    var Backbone = require('Backbone');
...
define('views/Block',['require','Backbone'],function(require){
    var Backbone = require('Backbone');
